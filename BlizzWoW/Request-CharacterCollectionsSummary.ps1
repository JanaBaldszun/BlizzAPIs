function Request-CharacterCollectionsSummary
{
  param(
    ...
    [ValidateSet('Mounts','Pets','Toys','Heirlooms')][String]
    $Collection
  )
  ...
  $EndpointPath = "profile/wow/character/$realmSlug/$characterName/collections/$Collection"
